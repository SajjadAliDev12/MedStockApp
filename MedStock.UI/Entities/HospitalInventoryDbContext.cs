...
public partial class HospitalInventoryDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Department>(entity =>
        {
            ...
            entity.HasIndex(e => e.DepartmentCode, "UX_Departments_Code_NotNull")
                .IsUnique()
        ...
        modelBuilder.Entity<RequisitionDetail>(entity =>
        {
            ...
            entity.Property(e => e.FulfilledQty).HasColumnType("decimal(18, 2)");
        ...
        modelBuilder.Entity<TransactionDetail>(entity =>
        {
            ...
            entity.ToTable("Transaction_Details", tb =>
                {
                    tb.HasTrigger("TR_TransactionDetails_AfterInsert");
                    tb.HasTrigger("trg_TransactionDetails_StockLedger");
                });
